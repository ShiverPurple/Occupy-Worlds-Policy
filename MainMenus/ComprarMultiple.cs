...
public class ComprarMultiple : MonoBehaviour
{
    ...
    public void ComprarMultiplier()
    {
        if (holdMultiplier == 0)
        {
            ...
            BuildMenu.asteroidValues[0] *= Power(1.215d, 9d);
            BuildMenu.asteroidValues[1] *= Power(1.32d, 9d);
            BuildMenu.asteroidValues[2] *= Power(1.5d, 9d);
        ...
        else if (holdMultiplier == 1)
        {
            ...
            BuildMenu.asteroidValues[0] = (BuildMenu.asteroidValues[0] / Power(1.215d, 9d)) * Power(1.215d, 99d);
            BuildMenu.asteroidValues[1] = (BuildMenu.asteroidValues[1] / Power(1.32d, 9d)) * Power(1.32d, 99d);
            BuildMenu.asteroidValues[2] = (BuildMenu.asteroidValues[2] / Power(1.5d, 9d)) * Power(1.5d, 99d);
        ...
        else if (holdMultiplier == 2)
        {
            ...
            BuildMenu.asteroidValues[0] = BuildMenu.asteroidValues[0] / Power(1.215d, 99d);
            BuildMenu.asteroidValues[1] = BuildMenu.asteroidValues[1] / Power(1.32d, 99d);
            BuildMenu.asteroidValues[2] = BuildMenu.asteroidValues[2] / Power(1.5d, 99d);
