...
public class ComprarMultiple : MonoBehaviour
{
    ...
    public void ComprarMultiplier()
    {
        if (holdMultiplier == 0)
        {
            ...
            tempUpgradeCosts = CostTimesTen(40d, 1.13d, UpgradeMenu.currentAmountUpgradeA[0]) + (3 * (40d * Power(1.13d, (UpgradeMenu.currentAmountUpgradeA[0] + 9))));
            ...
            tempBuildCosts[0] = CostTimesTen(fixBuildCost1, buildCostMultiplier1, BuildMenu.currentAmountBuildA[0]) + (3 * (fixBuildCost1 * Power(buildCostMultiplier1, (BuildMenu.currentAmountBuildA[0] + 9))));
            tempBuildCosts[1] = CostTimesTen(fixBuildCost2, buildCostMultiplier2, BuildMenu.currentAmountBuildA[1]) + (3 * (fixBuildCost2 * Power(buildCostMultiplier2, (BuildMenu.currentAmountBuildA[1] + 9))));
            tempBuildCosts[2] = CostTimesTen(fixBuildCost3, buildCostMultiplier3, BuildMenu.currentAmountBuildA[2]) + (3 * (fixBuildCost3 * Power(buildCostMultiplier3, (BuildMenu.currentAmountBuildA[2] + 9))));
            tempBuildCosts[3] = CostTimesTen(fixBuildCost4, buildCostMultiplier4, BuildMenu.currentAmountBuildA[3]) + (3 * (fixBuildCost4 * Power(buildCostMultiplier4, (BuildMenu.currentAmountBuildA[3] + 9))));
            tempBuildCosts[4] = CostTimesTen(fixBuildCost5, buildCostMultiplier5, BuildMenu.currentAmountBuildA[4]) + (3 * (fixBuildCost5 * Power(buildCostMultiplier5, (BuildMenu.currentAmountBuildA[4] + 9))));
            tempBuildCosts[5] = CostTimesTen(fixBuildCost6, buildCostMultiplier6, BuildMenu.currentAmountBuildA[5]) + (3 * (fixBuildCost6 * Power(buildCostMultiplier6, (BuildMenu.currentAmountBuildA[5] + 9))));
            tempBuildCosts[6] = CostTimesTen(fixBuildCost7, buildCostMultiplier7, BuildMenu.currentAmountBuildA[6]) + (3 * (fixBuildCost7 * Power(buildCostMultiplier7, (BuildMenu.currentAmountBuildA[6] + 9))));
            tempBuildCosts[7] = CostTimesTen(fixBuildCost8, buildCostMultiplier8, BuildMenu.currentAmountBuildA[7]) + (3 * (fixBuildCost8 * Power(buildCostMultiplier8, (BuildMenu.currentAmountBuildA[7] + 9))));
        ...
        else if (holdMultiplier == 1)
        {
            ...
            tempUpgradeCosts = CostTimesHundred(40d, 1.13d, UpgradeMenu.currentAmountUpgradeA[0]) + BonusCostPerTen(40d, 1.13d, UpgradeMenu.currentAmountUpgradeA[0]);
            ...
            tempBuildCosts[0] = CostTimesHundred(fixBuildCost1, buildCostMultiplier1, BuildMenu.currentAmountBuildA[0]) + BonusCostPerTen(fixBuildCost1, buildCostMultiplier1, BuildMenu.currentAmountBuildA[0]);
            tempBuildCosts[1] = CostTimesHundred(fixBuildCost2, buildCostMultiplier2, BuildMenu.currentAmountBuildA[1]) + BonusCostPerTen(fixBuildCost2, buildCostMultiplier2, BuildMenu.currentAmountBuildA[1]);
            tempBuildCosts[2] = CostTimesHundred(fixBuildCost3, buildCostMultiplier3, BuildMenu.currentAmountBuildA[2]) + BonusCostPerTen(fixBuildCost3, buildCostMultiplier3, BuildMenu.currentAmountBuildA[2]);
            tempBuildCosts[3] = CostTimesHundred(fixBuildCost4, buildCostMultiplier4, BuildMenu.currentAmountBuildA[3]) + BonusCostPerTen(fixBuildCost4, buildCostMultiplier4, BuildMenu.currentAmountBuildA[3]);
            tempBuildCosts[4] = CostTimesHundred(fixBuildCost5, buildCostMultiplier5, BuildMenu.currentAmountBuildA[4]) + BonusCostPerTen(fixBuildCost5, buildCostMultiplier5, BuildMenu.currentAmountBuildA[4]);
            tempBuildCosts[5] = CostTimesHundred(fixBuildCost6, buildCostMultiplier6, BuildMenu.currentAmountBuildA[5]) + BonusCostPerTen(fixBuildCost6, buildCostMultiplier6, BuildMenu.currentAmountBuildA[5]);
            tempBuildCosts[6] = CostTimesHundred(fixBuildCost7, buildCostMultiplier7, BuildMenu.currentAmountBuildA[6]) + BonusCostPerTen(fixBuildCost7, buildCostMultiplier7, BuildMenu.currentAmountBuildA[6]);
            tempBuildCosts[7] = CostTimesHundred(fixBuildCost8, buildCostMultiplier8, BuildMenu.currentAmountBuildA[7]) + BonusCostPerTen(fixBuildCost8, buildCostMultiplier8, BuildMenu.currentAmountBuildA[7]);
        ...
        else if (holdMultiplier == 2)
        {
            ...
            {
                tempUpgradeCosts = 3 * (40d * Power(1.13d, (UpgradeMenu.currentAmountUpgradeA[0] - 1)));
            }
            else
            {
                tempUpgradeCosts = 40d * Power(1.13d, UpgradeMenu.currentAmountUpgradeA[0]);
            }
            ...
            {
                tempBuildCosts[0] = 3 * (fixBuildCost1 * Power(buildCostMultiplier1, (BuildMenu.currentAmountBuildA[0] - 1)));
            }
            else
            {
                tempBuildCosts[0] = fixBuildCost1 * Power(buildCostMultiplier1, BuildMenu.currentAmountBuildA[0]);
            }

            if (BuildMenu.buildCheckArray[1] == true)
            {
                tempBuildCosts[1] = 3 * (fixBuildCost2 * Power(buildCostMultiplier2, (BuildMenu.currentAmountBuildA[1] - 1)));
            }
            else
            {
                tempBuildCosts[1] = fixBuildCost2 * Power(buildCostMultiplier2, BuildMenu.currentAmountBuildA[1]);
            }

            if (BuildMenu.buildCheckArray[2] == true)
            {
                tempBuildCosts[2] = 3 * (fixBuildCost3 * Power(buildCostMultiplier3, (BuildMenu.currentAmountBuildA[2] - 1)));
            }
            else
            {
                tempBuildCosts[2] = fixBuildCost3 * Power(buildCostMultiplier3, BuildMenu.currentAmountBuildA[2]);
            }

            if (BuildMenu.buildCheckArray[3] == true)
            {
                tempBuildCosts[3] = 3 * (fixBuildCost4 * Power(buildCostMultiplier4, (BuildMenu.currentAmountBuildA[3] - 1)));
            }
            else
            {
                tempBuildCosts[3] = fixBuildCost4 * Power(buildCostMultiplier4, BuildMenu.currentAmountBuildA[3]);
            }

            if (BuildMenu.buildCheckArray[4] == true)
            {
                tempBuildCosts[4] = 3 * (fixBuildCost5 * Power(buildCostMultiplier5, (BuildMenu.currentAmountBuildA[4] - 1)));
            }
            else
            {
                tempBuildCosts[4] = fixBuildCost5 * Power(buildCostMultiplier5, BuildMenu.currentAmountBuildA[4]);
            }

            if (BuildMenu.buildCheckArray[5] == true)
            {
                tempBuildCosts[5] = 3 * (fixBuildCost6 * Power(buildCostMultiplier6, (BuildMenu.currentAmountBuildA[5] - 1)));
            }
            else
            {
                tempBuildCosts[5] = fixBuildCost6 * Power(buildCostMultiplier6, BuildMenu.currentAmountBuildA[5]);
            }

            if (BuildMenu.buildCheckArray[6] == true)
            {
                tempBuildCosts[6] = 3 * (fixBuildCost7 * Power(buildCostMultiplier7, (BuildMenu.currentAmountBuildA[6] - 1)));
            }
            else
            {
                tempBuildCosts[6] = fixBuildCost7 * Power(buildCostMultiplier7, BuildMenu.currentAmountBuildA[6]);
            }

            if (BuildMenu.buildCheckArray[7] == true)
            {
                tempBuildCosts[7] = 3 * (fixBuildCost8 * Power(buildCostMultiplier8, (BuildMenu.currentAmountBuildA[7] - 1)));
            }
            else
            {
                tempBuildCosts[7] = fixBuildCost8 * Power(buildCostMultiplier8, BuildMenu.currentAmountBuildA[7]);
            }
