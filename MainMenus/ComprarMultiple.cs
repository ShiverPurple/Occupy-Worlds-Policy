...
public class ComprarMultiple : MonoBehaviour
{
    ...
    public void ComprarMultiplier()
    {
        if (holdMultiplier == 0)
        {
            ...
            BuildMenu.tempAsteroidValues[0] *= Power(1.215d, 10d);
            BuildMenu.tempAsteroidValues[1] *= Power(1.32d, 10d);
            BuildMenu.tempAsteroidValues[2] *= Power(1.5d, 10d);
        ...
        else if (holdMultiplier == 1)
        {
            ...
            BuildMenu.tempAsteroidValues[0] = (BuildMenu.tempAsteroidValues[0] / Power(1.215d, 10d)) * Power(1.215d, 100d);
            BuildMenu.tempAsteroidValues[1] = (BuildMenu.tempAsteroidValues[1] / Power(1.32d, 10d)) * Power(1.32d, 100d);
            BuildMenu.tempAsteroidValues[2] = (BuildMenu.tempAsteroidValues[2] / Power(1.5d, 10d)) * Power(1.5d, 100d);
        ...
        else if (holdMultiplier == 2)
        {
            ...
            BuildMenu.tempAsteroidValues[0] = BuildMenu.tempAsteroidValues[0] / Power(1.215d, 100d);
            BuildMenu.tempAsteroidValues[1] = BuildMenu.tempAsteroidValues[1] / Power(1.32d, 100d);
            BuildMenu.tempAsteroidValues[2] = BuildMenu.tempAsteroidValues[2] / Power(1.5d, 100d);
