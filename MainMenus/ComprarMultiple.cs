...
public class ComprarMultiple : MonoBehaviour
{
    ...
    private double perSecondMultiplier1 = 1.5d;
    private double perSecondMultiplier2 = 1.67d;
    private double perSecondMultiplier3 = 1.84d;
    private double perSecondMultiplier4 = 2.14d;
    private double perSecondMultiplier5 = 2.31d;
    private double perSecondMultiplier6 = 2.61d;
    private double perSecondMultiplier7 = 2.78d;
    private double perSecondMultiplier8 = 3.4d;
    ...
    public void ComprarMultiplier()
    {
        if (holdMultiplier == 0)
        {
            ...
            tempBuildCosts[7] = CostTimesTen(fixBuildCost8, 1.32d, BuildMenu.currentAmountBuildA[7]) + (3 * (fixBuildCost8 * Power(1.32d, (BuildMenu.currentAmountBuildA[7] + 9))));
        ...
        else if (holdMultiplier == 1)
        {
            ...
            tempBuildCosts[7] = CostTimesHundred(fixBuildCost8, 1.32d, BuildMenu.currentAmountBuildA[7]) + BonusCostPerTen(fixBuildCost8, 1.32d, BuildMenu.currentAmountBuildA[7]);
        ...
        else if (holdMultiplier == 2)
        {
            ...
            {
                tempBuildCosts[7] = 3 * (fixBuildCost8 * Power(1.32d, (BuildMenu.currentAmountBuildA[7] - 1)));
            }
            else
            {
                tempBuildCosts[7] = fixBuildCost8 * Power(1.32d, BuildMenu.currentAmountBuildA[7]);
            }
