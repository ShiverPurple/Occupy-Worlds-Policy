...
public class UpgradeMenu : MonoBehaviour
{
    ...
    private double upgradeCostMultiplier1 = 1.27d;
    private double upgradeCostMultiplier2 = 1.47d;
    ...
    public void ReloadDescriptions(int objectNumber)
    {
        switch (objectNumber)
        {
            ...
            case 7:
                ...
                break;
            case 8:
                upgradeInfoDisplay[objectNumber].text = "Dobra Click e Click/s atual";
                break;
        }
    }
        ...
        for (int i = 0; i < 9; i++)
        {
            switch (i)
            {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    upgradeInfoDisplay[i].SetText("Dobra Click e Click/s atual");
                    break;
            }
        }
    }
        ...
        if(ComprarMultiple.tempUpgradeCosts < GlobalMoney.moneyCount)
        {
            if (ComprarMultiple.holdMultiplier == 0)
            {
                ...
                if (doubleClickCost == true)
                {
                    ...
                    upgradeCosts[objectNumber] *= 1.13d;
            ...
            else if (ComprarMultiple.holdMultiplier == 1)
            {
                ...
                ComprarMultiple.tempUpgradeCosts = ComprarMultiple.instance.CostTimesTen(40d, 1.13d, currentAmountUpgradeA[objectNumber]) + 
                    (3 * (40d * ComprarMultiple.instance.Power(1.13d, (currentAmountUpgradeA[objectNumber] + 9))));
            ...
            else if (ComprarMultiple.holdMultiplier == 2)
            {
                ...
                ComprarMultiple.tempUpgradeCosts = ComprarMultiple.instance.CostTimesHundred(40d, 1.13d, currentAmountUpgradeA[objectNumber]) + 
                    ComprarMultiple.instance.BonusCostPerTen(40d, 1.13d, currentAmountUpgradeA[objectNumber]);
    ...
    void OfflineClickButton(int objectNumber, double[] upgradeCosts, int[] currentAmountUpgradeA)
    {
        if(upgradeCosts[objectNumber] <= GlobalMoney.moneyCount && exceededAmount3 == false)
        {
            GlobalMoney.moneyCount -= upgradeCosts[objectNumber];
            currentAmountUpgradeA[objectNumber] += 1;
            upgradeCosts[objectNumber] *= 2.4d;
