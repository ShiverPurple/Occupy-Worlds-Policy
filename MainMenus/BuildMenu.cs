...
public class BuildMenu : MonoBehaviour
{
    ...
    void AsteroidValueIncrease(int objectNumber, 
        ...
        if (asteroidCosts[asteroidNumber] <= GlobalMoney.moneyCount)
        {
            ...
            {
                tempAsteroidValues[asteroidNumber] = tempAsteroidValues[asteroidNumber] / ComprarMultiple.instance.Power(meteorValueMultiply, 9d);
                ...
                tempAsteroidValues[asteroidNumber] *= ComprarMultiple.instance.Power(meteorValueMultiply, 9d) * ComprarMultiple.instance.Power(meteorValueMultiply, 9d);
                asteroidValues[asteroidNumber] = tempAsteroidValues[asteroidNumber];
            }
            else if (ComprarMultiple.holdMultiplier == 2)
            {

                tempAsteroidValues[asteroidNumber] = tempAsteroidValues[asteroidNumber] / ComprarMultiple.instance.Power(meteorValueMultiply, 99);
                ...
                tempAsteroidValues[asteroidNumber] *= ComprarMultiple.instance.Power(meteorValueMultiply, 99d) * ComprarMultiple.instance.Power(meteorValueMultiply, 99d);
                asteroidValues[asteroidNumber] = tempAsteroidValues[asteroidNumber];
            }
