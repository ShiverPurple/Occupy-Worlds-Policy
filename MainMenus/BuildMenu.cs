...
public class BuildMenu : MonoBehaviour
{
    ...
    void AsteroidValueIncrease(int objectNumber, 
        ...
        if (asteroidCosts[asteroidNumber] <= GlobalMoney.moneyCount)
        {
            ...
            {
                asteroidValues[asteroidNumber] = asteroidValues[asteroidNumber] / ComprarMultiple.instance.Power(meteorValueMultiply, 9d);
                ...
                asteroidValues[asteroidNumber] *= ComprarMultiple.instance.Power(meteorValueMultiply, 9d) * ComprarMultiple.instance.Power(meteorValueMultiply, 9d);
            }
            else if (ComprarMultiple.holdMultiplier == 2)
            {

                asteroidValues[asteroidNumber] = asteroidValues[asteroidNumber] / ComprarMultiple.instance.Power(meteorValueMultiply, 99);
                ...
                asteroidValues[asteroidNumber] *= ComprarMultiple.instance.Power(meteorValueMultiply, 99d) * ComprarMultiple.instance.Power(meteorValueMultiply, 99d);
            }
