...
public class PlayerData 
{
    ...
    public double saveTempAsteroidValues1;
    public double saveTempAsteroidValues2;
    public double saveTempAsteroidValues3;
    ...
    public static void GetValues(PlayerData data)
    {
        ...
        data.saveTempAsteroidValues1 = BuildMenu.tempAsteroidValues[0];
        data.saveTempAsteroidValues2 = BuildMenu.tempAsteroidValues[1];
        data.saveTempAsteroidValues3 = BuildMenu.tempAsteroidValues[2];
